...
upload_('data.csv', 'my-bucket-lab4')
upload_('euro.csv', 'my-bucket-lab4')
upload_('dollar.csv', 'my-bucket-lab4')
...
obj = s3.Object("my-bucket-lab4", "euro.csv")
obj1 = s3.Object("my-bucket-lab4", "dollar.csv")
...
s3_client = boto3.client('s3')
s3_client.upload_file('plot.png', 'my-bucket-lab4', 'plot.png')